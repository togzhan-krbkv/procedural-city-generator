...
Early development. Milestones 1 through 5 are complete: shape grammar floor plans, the street network with parcel division, block composition, extrusion to a JSON scene, and a Three.js viewer that loads and renders it. Milestone 6, deploying the viewer to GitHub Pages, is next.
